...
const registro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userUnico = yield user_1.User.findOne({ where: { [sequelize_1.Op.or]: { correo: correo, cedula: cedula } } });
    if (userUnico) {
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userUnico = yield user_1.User.findOne({ where: { correo: correo } });
    if (!userUnico) {
